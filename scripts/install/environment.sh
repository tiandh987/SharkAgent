...
# iam 配置
readonly IAM_DATA_DIR=${IAM_DATA_DIR:-/data/iam}           # iam 各组件数据目录    /data/iam
readonly IAM_INSTALL_DIR=${IAM_INSTALL_DIR:-/opt/iam}      # iam 安装文件存放目录  /opt/iam
readonly IAM_CONFIG_DIR=${IAM_CONFIG_DIR:-/etc/iam}        # iam 配置文件存放目录  /etc/iam
readonly IAM_LOG_DIR=${IAM_LOG_DIR:-/var/log/iam}          # iam 日志文件存放目录  /var/log/iam
readonly CA_FILE=${CA_FILE:-${IAM_CONFIG_DIR}/cert/ca.pem} # CA                   /etc/iam/cert/ca.pem
